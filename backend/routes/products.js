...
router.post('/seed', protect, adminOnly, async (req, res) => {
  try {
    const products = [
      ...
      { name: "Men Formal Suit Navy Blue", price: 199.00, oldPrice: 279.00, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6_zFOEjgUGuefP2A5ipcjy4nlxYvZIrhsKQ&s", description: "Elegant navy blue formal suit.", category: "Clothes", stock: 20, rating: 5, reviews: 89, shipping: "Free Shipping" },
